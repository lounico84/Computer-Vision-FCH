...
class PathConfig:
    ...
    # Output
    output_video: Path = "output_video_match/output_video_k_3.avi"
    color_debug_image: Path = "output_video_match/color_debug.png"

    # Stubs
    tracks_stub: Path = PROJECT_ROOT / "stubs/track_stubs_k_3.pkl"

    # Analytics
    frame_events_csv: Path = PROJECT_ROOT / "analytics/frame_events_3_1.csv"
    pass_map_team1: Path = PROJECT_ROOT / "analytics/pass_maps/pass_map_team1_3_1.png"
    pass_map_team2: Path = PROJECT_ROOT / "analytics/pass_maps/pass_map_team2_3_1.png"
